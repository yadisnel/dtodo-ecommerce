...
func (x *accountServiceStream) Context() context.Context {
...
func (x *accountServicePingPong) Context() context.Context {
	return x.stream.Context()
}
...
func (x *accountStreamStream) Context() context.Context {
	return x.stream.Context()
}
...
func (x *accountPingPongStream) Context() context.Context {
	return x.stream.Context()
}
