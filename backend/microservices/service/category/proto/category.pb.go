...
var file_proto_category_proto_rawDesc = []byte{
	...
	0xb4, 0x01, 0x0a, 0x08, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x12, 0x2f, 0x0a, 0x04,
	0x43, 0x61, 0x6c, 0x6c, 0x12, 0x11, 0x2e, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x2e,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f,
	0x72, 0x79, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x45, 0x0a,
	0x06, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x1a, 0x2e, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f,
	0x72, 0x79, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x2e, 0x53,
	...
	0x12, 0x0e, 0x2e, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x2e, 0x50, 0x69, 0x6e, 0x67,
	0x1a, 0x0e, 0x2e, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x2e, 0x50, 0x6f, 0x6e, 0x67,
...
var file_proto_category_proto_goTypes = []interface{}{
	(*Message)(nil),           // 0: category.Message
	(*Request)(nil),           // 1: category.Request
	(*Response)(nil),          // 2: category.Response
	(*StreamingRequest)(nil),  // 3: category.StreamingRequest
	(*StreamingResponse)(nil), // 4: category.StreamingResponse
	(*Ping)(nil),              // 5: category.Ping
	(*Pong)(nil),              // 6: category.Pong
}
var file_proto_category_proto_depIdxs = []int32{
	1, // 0: category.Category.Call:input_type -> category.Request
	3, // 1: category.Category.Stream:input_type -> category.StreamingRequest
	5, // 2: category.Category.PingPong:input_type -> category.Ping
	2, // 3: category.Category.Call:output_type -> category.Response
	4, // 4: category.Category.Stream:output_type -> category.StreamingResponse
	6, // 5: category.Category.PingPong:output_type -> category.Pong
